...
/**
 * Provides a convenient base class for creating a {@link org.springframework.security.config.annotation.web.WebSecurityConfigurer}
 ...
 */
@Order(100)
public abstract class CustomWebSecurityConfigurerAdapter implements WebSecurityConfigurer<WebSecurity> {
    private final Log logger = LogFactory.getLog(CustomWebSecurityConfigurerAdapter.class);
     ...
     */
    protected CustomWebSecurityConfigurerAdapter() {
        this(false);
    }
     ...
     *            false
     */
    protected CustomWebSecurityConfigurerAdapter(boolean disableDefaults) {
     ...
     * populated {@link org.springframework.security.core.userdetails.UserDetailsService} that is created with the
